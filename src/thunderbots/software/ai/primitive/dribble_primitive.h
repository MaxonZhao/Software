...
#ifndef PRIMITIVE_DRIBBLEPRIMTIVE_H
#define PRIMITIVE_DRIBBLEPRIMTIVE_H
...
public:
     ...
     */
    explicit DribblePrimitive(const thunderbots_msgs::Primitive &primtiive_msg);
...
#endif //PRIMITIVE_DRIBBLEPRIMTIVE_H
